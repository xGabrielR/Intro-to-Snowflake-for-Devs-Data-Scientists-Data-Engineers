...
-- 2. Run a list command (“ls”) to view the staged files. What number do you see in the size column for “truck.csv.gz”?

LS @test_ingestion.public.test_stage/truck.csv.gz;
...
-- 4. Which of the following creates an external stage?
/*
...
DROP DATABASE IF EXISTS test_ingestion;